...
function Cart(props) {
  ...
  function Sum_Price(carts, sum_price) {
    carts.map((value) => {
      return (sum_price +=
        parseInt(value.count) * parseInt(value.price_product));
    });
              ...
              <form action="#">
                <div className="table-content table-responsive">
                  <table className="table">
                    <thead>
                      <tr>
                        <th className="li-product-remove">Xoá</th>
                    ...
                    <tbody>
                      {list_carts &&
                        list_carts.map((value, index) => (
                          <tr key={index}>
                            <td
                              className="li-product-remove"
                              onClick={() =>
                                handler_delete_carts(value.id_cart)
                              }
                            >
