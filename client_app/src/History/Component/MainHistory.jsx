              ...
              <form action="#">
                <div className="table-content table-responsive">
                  <table className="table">
                    <thead>
                      <tr>
                        <th className="li-product-remove">ID Hoá đơn</th>
                        ...
                        <th className="li-product-subtotal">Huỷ</th>
                      </tr>
                    </thead>
                    <tbody>
                      {history &&
                          ...
                          <tr key={value._id}>
                            <td className="li-product-price">
                              <span className="amount">
                                <Link to={`/history/${value._id}`}>Xem</Link>
                              </span>
                            </td>
                            <td className="li-product-price">
                              <span className="amount">
                            ...
                            <td className="li-product-price">
                              ...
                              >
                                {value.pay ? "Đã thanh toán" : "Chưa thanh toán"}
                              </span>
                            </td>
                            <td className="li-product-price">
                              <span className="amount">
