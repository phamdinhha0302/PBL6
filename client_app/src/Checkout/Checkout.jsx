...
function Checkout(props) {
  ...
  function Sum_Price(carts, sum_price) {
    ...
    if (localStorage.getItem("coupon")) {
      ...
      const newTotal =
        total - (total * parseInt(coupon.promotion)) / 100 + Number(price);
  ...
  const [from, set_from] = useState(
    "155 Sư Vạn Hạnh, Phường 13, District 10, Ho Chi Minh City, Vietnam"
  );
